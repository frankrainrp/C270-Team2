...
import { X, Moon, Feather, Pencil, Type, Heart, MessageSquare, Flame, Palette, RotateCcw, Upload, Volume2, VolumeX, Languages } from "lucide-react";
import {
  ACCENT_PRESETS,
  DEFAULT_ACCENT,
  applyStoredAccent,
        ...
        <div style={{ padding: 18, display: "flex", flexDirection: "column", gap: 18, overflowY: "auto", flex: 1, minHeight: 0 }}>
          ...
          <Section title={t("prefs.section.accent")}>
            ...
            <p style={{ fontSize: 11, color: "var(--color-text-faint)", marginTop: 8, lineHeight: 1.5 }}>
              Hover and soft colors are derived automatically; dark mode is brightened for contrast
            </p>
          </Section>
          ...
          <Section title={t("prefs.section.layout")}>
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <div>
                ...
                <p style={{ fontSize: 11, color: "var(--color-text-faint)", marginTop: 6, lineHeight: 1.5 }}>
                  Click to toggle visibility; drag tabs in the top bar to reorder them
                </p>
              </div>
            </div>
          </Section>
          ...
          <Section title={t("prefs.section.sound")}>
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <p style={{ fontSize: 11, color: "var(--color-text-faint)", lineHeight: 1.5, margin: 0 }}>
                Sounds are generated in the browser with no external files or network access; off by default
              </p>
            </div>
          </Section>
          ...
          <Section title={t("prefs.section.personality")}>
            ...
            <p style={{ fontSize: 11, color: "var(--color-text-faint)", marginTop: 6, lineHeight: 1.5 }}>
              Changes the AI conversation tone; takes effect from the next message
            </p>
          </Section>
        </div>
