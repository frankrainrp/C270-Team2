...
export const VAULT_PATH = resolve(process.env.BUTLER_VAULT ?? resolve(__dirname, "..", "butler-vault.json"));
const EMPTY = { notes: [], tasks: [], workflows: [] };
...
export async function loadVault() {
    ...
    try {
        ...
        throw new Error(`Vault at ${VAULT_PATH} is not valid JSON: ${err.message}`);
    }
}
...
export async function mutateVault(fn) {
